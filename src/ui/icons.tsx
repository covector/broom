...
export const AddIcon = () => (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M18 4V32M4 18H32" strokeWidth="7" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);

export const RemoveIcon = () => (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M8.1 8.1L27.9 27.9M8.1 27.9L27.9 8.1" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);
...
export const SpinArrowIcon = () => (
    <svg width="272" height="272" viewBox="0 0 272 272" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0)">
        <path d="M161.475 227.362C212.897 222.863 250.935 177.53 246.437 126.108C241.938 74.6858 196.605 36.647 145.183 41.1459C93.7608 45.6447 55.722 90.9776 60.2209 142.4M60.2209 142.4L22.4303 68.3595M60.2209 142.4L131.211 115.498" strokeWidth="43" strokeLinecap="round" strokeLinejoin="round"/>
        </g>
        <defs>
        <clipPath id="clip0">
        <rect width="272" height="272"/>
